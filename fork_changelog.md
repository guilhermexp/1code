...
- Private commits: 86
- Commit list:
  - f88ac49 Add support for Codex binary download in release scripts
  - 491e686 Adicionar drag-drop em painel de f s
  - 897d2a2 Log electron dev startup status
  - 9d34cbd Review fork sync dev logs
  - 9495490 docs(sync): update fork changelog and sync report
  - 810eb4a chore(sync): merge upstream/main preserving local customizations
  - 08dd0f9 Fix nativeImage ReferenceError
  - 78d88bc fix(dev): remove noisy dev warnings and stabilize preview fallback
  - 6d18de9 fix(sync): add container-queries dependency and update sync reports
  - e5594b6 chore(sync): merge upstream/main preserving local customizations
