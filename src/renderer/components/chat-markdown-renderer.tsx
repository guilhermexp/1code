...
export const ChatMarkdownRenderer = memo(function ChatMarkdownRenderer({
  ...
  const components = useMemo(
    ...
    [styles, codeTheme, size, onUrlClick, isStreaming],
  )
...
const MemoizedMarkdownBlock = memo(
  function MemoizedMarkdownBlock({
    ...
    const components = useMemo(
        ...
        a: ({ href, children, ...props }: any) => {
          ...
          return (
            <a
              ...
              className="text-blue-600 dark:text-blue-400 no-underline hover:underline hover:decoration-current underline-offset-2 decoration-1 transition-all duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-1 focus-visible:ring-blue-500/30 focus-visible:rounded-sm"
              {...props}
            >
              {children}
              {/* Visual indicator for preview-able URLs */}
      ...
      [styles, codeTheme, size, onUrlClick],
    )
